  ...
  <div class="zcgl-title"><span id="voyage">添加班期</span></div>
      ...
      <div class="info-content" style="margin-top: 10px;">
	 	...
	 	<div style="padding:  10px 12px 15px 12px;overflow: hidden;" id="goodsInfo">
		 	...
		 	<div class="cabin-type-name "><input class="form-control goodsName" value="保险" readonly="true" type="text"></div>
		 	<div class="cabin-name "><input class="form-control goodsTotalNum" value="不限" readonly="true" type="text"><input value="0" type="text" style="display:none;"></div>
		 	<div class="cabin-name "><input class="form-control goodsNum" value="不限" type="text" readonly="true"><input value="0" type="text" style="display:none;"></div>
		 	<div class="cabin cabinNum "><input class="form-control goodsPrice" placeholder="未设定" type="text" id="insurance"></div>
		 	<div class="cabin cabinNum " style="display:none"><input class="form-control" value="" type="text" id="insuranceId"></div>
		 	<button type="submit" class="btn btn-primary fleft saveInsuranceGoods " onclick="saveGoods(this);" style="margin: 0px 0 0 10px;">保存</button>
		 	<button type="submit" class="btn btn-primary fleft editGoods editInsuranceGoods" style="margin: 0px 0 0 10px;display:none;">修改</button>
		 	</li>
		 	<li style="margin-bottom: 10px;">
		 	<div class="cabin-type-name "><input class="form-control goodsName" value="大巴" readonly="true" type="text"></div>
		 	<div class="cabin-name "><input class="form-control goodsTotalNum" value="不限" readonly="true" type="text"><input value="0" type="text" style="display:none;"></div>
		 	<div class="cabin-name "><input class="form-control goodsNum" value="不限" type="text" readonly="true"><input value="0" type="text" style="display:none;"></div>
		 	<div class="cabin cabinNum "><input class="form-control goodsPrice" placeholder="未设定" type="text" id="bus"></div>
		 	<div class="cabin cabinNum " style="display:none"><input class="form-control" value="" type="text" id="busId"></div>
		 	<button type="submit" class="btn btn-primary fleft saveBusGoods " onclick="saveGoods(this);"style="margin: 0px 0 0 10px;">保存</button>
		 	<button type="submit" class="btn btn-primary fleft editGoods editBusGoods" style="margin: 0px 0 0 10px;display:none;">修改</button>
		 	</li>
		 	<li style="margin-bottom: 10px;">
		 	<div class="cabin-type-name "><input class="form-control goodsName" value="挂舱" readonly="true" type="text"></div>
		 	<div class="cabin-name "><input class="form-control goodsTotalNum" placeholder="未设定"  type="text" id="addSpaceTotalNum"><input value="0" type="text" style="display:none;"></div>
		 	<div class="cabin-name "><input class="form-control goodsNum" placeholder="未设定"  type="text" readonly="true" id="addSpaceNum"><input value="0" type="text" style="display:none;"></div>
		 	<div class="cabin cabinNum "><input class="form-control goodsPrice" placeholder="未设定" type="text" id="addSpacePrice"></div>
		 	<div class="cabin cabinNum " style="display:none"><input class="form-control" value="" type="text" id="addSpaceId"></div>
		 	<button type="submit" class="btn btn-primary fleft saveAddSpaceGoods " onclick="saveGoods(this);" style="margin: 0px 0 0 10px;">保存</button>
		 	<button type="submit" class="btn btn-primary fleft editGoods editAddSpaceGoods" style="margin: 0px 0 0 10px;display:none;">修改</button>
		 	</li>
	 	</div>
             ...
             <div class="modal-header bg-title">
              ...
              <div class="modal-center-4">
               <ul>
				...
				<div class="modal-jsmc" style="width: 33%;">
				<h1>产品名称：</h1>
				...
				<div class="modal-jsmc" style="width: 50%;display:none;">
				<h1>产品剩余：</h1>
              ...
              <div class="modal-quanxian-footer ">
                  <input type="hidden" id="hiddenCode"></input>
                  <button type="button" class="btn btn-default " data-dismiss="modal">取消</button>
                  <button  type="button" class="btn btn-primary modal-tianjia-footer-mr"onclick="submitGoods()">确定</button>                 
              </div>
        </div>
	</div>
</div>
