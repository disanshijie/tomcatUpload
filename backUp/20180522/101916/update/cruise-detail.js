    ...
    if(productType == 21){
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data.success == 1) {
                    var datas = data.datas;
                     var str1='<div class="info-content" style="margin-top: 10px;">'+
                 	 	'<div class="yuding-title"><span>內舱房</span></div>';
                     var str2='<div class="info-content" style="margin-top: 10px;">'+
                     '<div class="yuding-title"><span>海景房</span></div>';
                     var str3='<div class="info-content" style="margin-top: 10px;">'+
                     '<div class="yuding-title"><span>阳台房</span></div>';
                     var str4='<div class="info-content" style="margin-top: 10px;">'+
                     '<div class="yuding-title"><span>套房</span></div>';
                     var str5='<div class="info-content" style="margin-top: 10px;">'+
                     '<div class="yuding-title"><span>附加产品</span></div>';
                   var newstr1=str1,newstr2=str2,newstr3=str3,newstr4=str4,newstr5=str5;
                    for(var i=0; i<datas.length; i++) {
	                    var list = '';
                    ...
                    if(str1 == newstr1) str1 = "";
                    if(str2 == newstr2) str2 = "";
                    if(str3 == newstr3) str3 = "";
                    if(str4 == newstr4) str4 = "";
                    if(str5 == newstr5) str5 = "";
...
//                        '</tr>';
                    ...
                    $('#houseList').html(str1+str2+str3+str4+str5);
                  //  $('#houseList').html(list);
                    ...
                    if(data.success == 1) {
                        ...
                        if(confirm("是否下载确认单")){
                        	...
                        	console.log(code);
                        	 ...
                        	 $("#form_condition").find(".code").val(code);
...
function minHousePrice(vid){
    $.ajax({
        url:getContextPath()+"/resource/getTraderMinHousePriceByVid.do",
        type:'post',
        data: {"productVersion.id":vid,
